...
- [ ] **E2E finding (2026-07-10, founder walked past the contact exchange without recognizing it):** (a) extend the in-session notice to revealed intros needing action (own contact not left / theirs unseen) — the agent must say "you both said yes — go leave your contact"; (b) revealed page leads with the action (form first: "Leave your contact so they can reach you"), explanation second; (c) reveal email subject/first line carries the to-do
